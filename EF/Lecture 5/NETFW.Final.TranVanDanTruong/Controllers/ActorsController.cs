...
namespace NETFW.Final.TranVanDanTruong.Controllers
{
    public class ActorsController : Controller
    {
        ...
        public ActionResult Index(string currentFilter, string searchString, int? page)
        {
            ...
            {
                actors = actors.Where(a => a.Name.Contains(searchString)).ToList();
            }
        ...
        public ActionResult Create([Bind(Include = "ID,Name,DateOfBirth")] Actor actor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,DateOfBirth")] Actor actor)
        {
            if (ModelState.IsValid)
            {
